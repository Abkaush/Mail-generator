...
class Chain:
    def __init__(self):
        # Updated model_name to a valid Groq-hosted model
        self.llm = ChatGroq(
            temperature=0, 
    ...
    def extract_jobs(self, cleaned_text):
        ...
        try:
            ...
            raise OutputParserException("Context too big or malformed JSON returned. Unable to parse jobs.")
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Mohan, a business development executive at Infosys. Infosys is an AI & Software Consulting company dedicated to facilitating
            ...
            Remember you are Mohan, BDE at Infosys. 
